...
export function Chatbot() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white"> {/* Updated background color */}
      ...
      <div className="border-t p-4 bg-white fixed bottom-0 left-0 right-0"> {/* Updated background color */}
